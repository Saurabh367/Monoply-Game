...
public class Squares {
	...
	public static void addProperties(){
		...
		squares.add(new CommunityChestAndChance("Community Chest"));
		squares.add(new Properties("Baltic Avenue", "brown", 60, 4, 20, 60, 180, 320, 450, 50, 0));
		squares.add(new TaxMoney("Income Tax"));
		...
		squares.add(new CommunityChestAndChance("Chance"));
		...
		squares.add(new GoToJail("Go to Jail"));
		...
		squares.add(new TaxMoney("Luxery Tax"));
