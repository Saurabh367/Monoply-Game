...
public class Squares {
	...
	public static void addProperties(){
		...
		squares.add(new CommunityChestAndChance("Chance", 0, 0, 0));
		...
		squares.add(new Jail("Jail", 0, 0, 0));
		...
		squares.add(new FreeParking("Free Parking", 0, 0, 0));
		...
		squares.add(new GoToJail("Go to Jail", 0, 0, 0));
		...
		squares.add(new TaxMoney("Luxury Tax", 0, 0, 0));
